...
def cloud_warning_text() -> str:
    return (
        ...
        "not what the provider receives, logs, or may train on. An \"OpenAI-compatible\"\n"
        "endpoint is NOT necessarily private: pick a provider you trust and whose\n"
        "retention/training policy you have read -- compatibility says nothing about it.\n"
        "\n"
